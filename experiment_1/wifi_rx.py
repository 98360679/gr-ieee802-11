...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.ieee802_11_frame_equalizer_0 = ieee802_11.frame_equalizer(ieee802_11.Equalizer(chan_est), freq, samp_rate, True, True)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*64, '/home/misty/Desktop/Code-Data/af.bin', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/misty/Desktop/wifi.pcap', True)
        ...
        self.msg_connect((self.ieee802_11_parse_mac_0, 'out'), (self.ieee802_11_parse_mac_0, 'in'))
        self.connect((self.blocks_file_source_0, 0), (self.ieee802_11_frame_equalizer_0, 0))
