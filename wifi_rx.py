...
import ieee802_11
import wifi_rx_ber_sink_0 as ber_sink_0  # embedded python block
import wifi_rx_frame_logger as frame_logger  # embedded python block
import wifi_rx_frame_rec_0 as frame_rec_0  # embedded python block
import wifi_rx_rx_power_0 as rx_power_0  # embedded python block
...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._rx_gain_range = Range(0, 1, 0.01, 0.6, 200)
        ...
        self.rx_power_0 = rx_power_0.blk(report_sec=2.0)
        ...
        self.frame_rec_0 = frame_rec_0.blk(log_path='/home/nghoselab/captures/fading_fingerprints_2412/day1/exp2/device_%d/ber_frames_run_%d.jsonl'%(device_id, run_id))
        self.frame_logger = frame_logger.blk(log_path='/home/nghoselab/captures/fading_fingerprints_2412/day1/exp2/device_%d/rx_frames_run_%d.jsonl'%(device_id,run_id))
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/nghoselab/captures/fading_fingerprints_2412/day1/exp2/device_%d/clean_run_%d.bin'%(device_id,run_id), False)
        ...
        self.ber_sink_0 = ber_sink_0.blk(report_sec=2.0, noise_threshold=0.3, seed=0)


        ##################################################
        # Connections
        ##################################################
        self.msg_connect((self.ieee802_11_decode_mac_0, 'failed'), (self.ber_sink_0, 'failed'))
        self.msg_connect((self.ieee802_11_decode_mac_0, 'out'), (self.ber_sink_0, 'valid'))
        self.msg_connect((self.ieee802_11_decode_mac_0, 'out'), (self.frame_logger, 'in'))
        self.msg_connect((self.ieee802_11_decode_mac_0, 'out'), (self.frame_rec_0, 'valid'))
        self.msg_connect((self.ieee802_11_decode_mac_0, 'failed'), (self.frame_rec_0, 'failed'))
        ...
        self.connect((self.blocks_tag_share_0, 0), (self.blocks_throttle2_0, 0))
        ...
        self.connect((self.pdu_pdu_to_tagged_stream_0, 0), (self.blocks_tag_share_0, 0))
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.rx_power_0, 0))
    ...
    def set_run_id(self, run_id):
        self.run_id = run_id
        self.blocks_file_sink_0_0.open('/home/nghoselab/captures/fading_fingerprints_2412/day1/exp2/device_%d/clean_run_%d.bin'%(self.device_id,self.run_id))
        self.frame_rec_0.log_path = '/home/nghoselab/captures/fading_fingerprints_2412/day1/exp2/device_%d/ber_frames_run_%d.jsonl'%(self.device_id, self.run_id)

    def get_psr(self):
        return self.psr

    def set_psr(self, psr):
        self.psr = psr
