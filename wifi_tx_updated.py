...
import foo
import ieee802_11
import wifi_tx_updated_epy_block_0 as epy_block_0  # embedded python block
import wifi_tx_updated_frame_recorder_0 as frame_recorder_0  # embedded python block



from gnuradio import qtgui

class wifi_tx_updated(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi Tx Updated", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Wifi Tx Updated")
        ...
        self.settings = Qt.QSettings("GNU Radio", "wifi_tx_updated")
        ...
        self._sample_rate_options = [5000000.0, 10000000.0, 20000000.0]
        # Create the labels list
        self._sample_rate_labels = ['5 MHz', '10 MHz', '20 MHz']
        # Create the combo box
        self._sample_rate_tool_bar = Qt.QToolBar(self)
        self._sample_rate_tool_bar.addWidget(Qt.QLabel("'sample_rate'" + ": "))
        ...
        self.top_layout.addWidget(self._sample_rate_tool_bar)
        ...
        # Create the options list
        self._lo_offset_options = [0, 6000000.0]
        # Create the labels list
        self._lo_offset_labels = ['0', '6000000.0']
        # Create the combo box
        ...
        # Create the options list
        self._freq_options = [2412000000.0, 2417000000.0, 2422000000.0, 2427000000.0, 2432000000.0, 2437000000.0, 2442000000.0, 2447000000.0, 2450000000.0, 2457000000.0, 2462000000.0, 2467000000.0, 2472000000.0, 2484000000.0, 3300000000.0, 5170000000.0, 5180000000.0, 5190000000.0, 5200000000.0, 5210000000.0, 5220000000.0, 5230000000.0, 5240000000.0, 5250000000.0, 5260000000.0, 5270000000.0, 5280000000.0, 5290000000.0, 5300000000.0, 5310000000.0, 5320000000.0, 5500000000.0, 5510000000.0, 5520000000.0, 5530000000.0, 5540000000.0, 5550000000.0, 5560000000.0, 5570000000.0, 5580000000.0, 5590000000.0, 5600000000.0, 5610000000.0, 5620000000.0, 5630000000.0, 5640000000.0, 5660000000.0, 5670000000.0, 5680000000.0, 5690000000.0, 5700000000.0, 5710000000.0, 5720000000.0, 5745000000.0, 5755000000.0, 5765000000.0, 5775000000.0, 5785000000.0, 5795000000.0, 5805000000.0, 5825000000.0, 5860000000.0, 5870000000.0, 5880000000.0, 5890000000.0, 5900000000.0, 5910000000.0, 5920000000.0, 2512000000.0, 2452000000.0, 1900000000.0]
        # Create the labels list
        self._freq_labels = ['  1 | 2412.0 | 11g', '  2 | 2417.0 | 11g', '  3 | 2422.0 | 11g', '  4 | 2427.0 | 11g', '  5 | 2432.0 | 11g', '  6 | 2437.0 | 11g', '  7 | 2442.0 | 11g', '  8 | 2447.0 | 11g', '  9 | 2450.0 | 11g', ' 10 | 2457.0 | 11g', ' 11 | 2462.0 | 11g', ' 12 | 2467.0 | 11g', ' 13 | 2472.0 | 11g', ' 14 | 2484.0 | 11g', ' 33 | 3300.0 | 11g', ' 34 | 5170.0 | 11a', ' 36 | 5180.0 | 11a', ' 38 | 5190.0 | 11a', ' 40 | 5200.0 | 11a', ' 42 | 5210.0 | 11a', ' 44 | 5220.0 | 11a', ' 46 | 5230.0 | 11a', ' 48 | 5240.0 | 11a', ' 50 | 5250.0 | 11a', ' 52 | 5260.0 | 11a', ' 54 | 5270.0 | 11a', ' 56 | 5280.0 | 11a', ' 58 | 5290.0 | 11a', ' 60 | 5300.0 | 11a', ' 62 | 5310.0 | 11a', ' 64 | 5320.0 | 11a', '100 | 5500.0 | 11a', '102 | 5510.0 | 11a', '104 | 5520.0 | 11a', '106 | 5530.0 | 11a', '108 | 5540.0 | 11a', '110 | 5550.0 | 11a', '112 | 5560.0 | 11a', '114 | 5570.0 | 11a', '116 | 5580.0 | 11a', '118 | 5590.0 | 11a', '120 | 5600.0 | 11a', '122 | 5610.0 | 11a', '124 | 5620.0 | 11a', '126 | 5630.0 | 11a', '128 | 5640.0 | 11a', '132 | 5660.0 | 11a', '134 | 5670.0 | 11a', '136 | 5680.0 | 11a', '138 | 5690.0 | 11a', '140 | 5700.0 | 11a', '142 | 5710.0 | 11a', '144 | 5720.0 | 11a', '149 | 5745.0 | 11a (SRD)', '151 | 5755.0 | 11a (SRD)', '153 | 5765.0 | 11a (SRD)', '155 | 5775.0 | 11a (SRD)', '157 | 5785.0 | 11a (SRD)', '159 | 5795.0 | 11a (SRD)', '161 | 5805.0 | 11a (SRD)', '165 | 5825.0 | 11a (SRD)', '172 | 5860.0 | 11p', '174 | 5870.0 | 11p', '176 | 5880.0 | 11p', '178 | 5890.0 | 11p', '180 | 5900.0 | 11p', '182 | 5910.0 | 11p', '184 | 5920.0 | 11p', '  0 | 2512.0 | oob', '  9 | 2452.0 | 11g', '  - | 1900.0 | vert900']
        # Create the combo box
        ...
        self.frame_recorder_0 = frame_recorder_0.blk(frame_file='/home/nghoselab/captures/fading_fingerprints_2412/day1/exp2/device_%d/frame_run_%d.bin'%(device_id, run_id), index_file='/home/nghoselab/captures/fading_fingerprints_2412/day1/exp2/device_%d/frame_index_run_%d.csv'%(device_id,run_id), pad_front=100, pad_tail=1000)
        self.foo_packet_pad2_0 = foo.packet_pad2(False, False, 0.01, 100, 1000)
        self.foo_packet_pad2_0.set_min_output_buffer(384000)
        self.epy_block_0 = epy_block_0.blk(pdu_length=pdu_length, seed=0, id_log='/home/nghoselab/captures/fading_fingerprints_2412/day1/exp2/device_%d/tx_ids_run_%d.csv'%(device_id,run_id))
        ...
        # Connections
        ##################################################
        self.msg_connect((self.blocks_message_strobe_0_0, 'strobe'), (self.epy_block_0, 'trig'))
        self.msg_connect((self.epy_block_0, 'out'), (self.ieee802_11_mac_0, 'app in'))
        ...
        self.connect((self.foo_packet_pad2_0, 0), (self.frame_recorder_0, 0))
    ...
    def set_sample_rate(self, sample_rate):
        ...
        self.wifi_phy_hier_0.set_bandwidth(self.sample_rate)
    ...
    def set_run_id(self, run_id):
        self.run_id = run_id
        self.epy_block_0.id_log = '/home/nghoselab/captures/fading_fingerprints_2412/day1/exp2/device_%d/tx_ids_run_%d.csv'%(self.device_id,self.run_id)
        self.frame_recorder_0.frame_file = '/home/nghoselab/captures/fading_fingerprints_2412/day1/exp2/device_%d/frame_run_%d.bin'%(self.device_id, self.run_id)
        self.frame_recorder_0.index_file = '/home/nghoselab/captures/fading_fingerprints_2412/day1/exp2/device_%d/frame_index_run_%d.csv'%(self.device_id,self.run_id)
    ...
    def set_pdu_length(self, pdu_length):
        ...
        self.epy_block_0.pdu_length = self.pdu_length
...
def main(top_block_cls=wifi_tx_updated, options=None):
